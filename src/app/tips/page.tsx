...
import AiTipsGenerator from '@/components/tips/ai-tips-generator';
      ...
      <main className="flex-grow">
        <section className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="mb-6">
              <h2 className="text-2xl font-bold font-headline">Best Practice Guidelines</h2>
              <p className="text-sm text-muted-foreground">Standard operating procedures for professional kitchen teams.</p>
            </div>
