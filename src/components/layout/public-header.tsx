      ...
      <div className="container flex h-16 items-center">
        ...
        <div className="flex flex-1 items-center justify-end space-x-2">
          ...
          <Button asChild variant="outline" size="sm" className="hidden lg:flex gap-1.5">
            <a href="/api/download-zip" download="food-wastage-detection.zip">
                ...
                <div className="p-4">
                  ...
                  <nav className="flex flex-col space-y-4">
                    ...
                    <a
                      ...
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="flex items-center gap-2 text-lg font-medium transition-colors hover:text-primary pt-2 border-t text-muted-foreground"
                    >
